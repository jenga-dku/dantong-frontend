  ...
  return (
    <Section title="신청한 행사">
      <div className="flex items-center">
        <EventInfoBox className="box-border h-full w-2/3 gap-2 px-2 py-3">
          <img className="w-1/3" src={thumbnail} alt="신청행사 썸네일" />
          <div className="flex w-[calc(66.6%-0.5rem)] flex-col justify-between gap-3">
            <h3 className="overflow-hidden text-ellipsis whitespace-nowrap rounded-md bg-primary px-1 py-2 text-center text-white">
              {eventName}
            </h3>
            <p>장소: {location}</p>
        ...
        <DividingLine />
        <DetailInfoBox className="h-full w-1/3 flex-col justify-between gap-2 px-2 py-3 ">
          ...
          <button className="btn btn-outline btn-primary h-9 min-h-9 whitespace-nowrap border-[1.5px]">
            정보 수정
          </button>
        </DetailInfoBox>
      </div>
